...
public class PrimitiveClub extends Modifier implements MeleeHitModifierHook {
    ...
    public void afterMeleeHit(IToolStackView tool, ModifierEntry modifier, ToolAttackContext context, float damageDealt){
        ...
        int dazingEdge = 2 * tool.getModifierLevel(ModifierId.tryParse("tinker_in_caves:dazing_sweep"));
        int durationBase = 10 + 5 * modifierLevel + 10 * tool.getModifierLevel(ModifierId.tryParse("tinker_in_caves:tremorsaurus"));
